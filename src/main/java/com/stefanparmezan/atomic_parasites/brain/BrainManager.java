...
public class BrainManager {
    ...
    // === ПУБЛИЧНЫЕ МЕТОДЫ ===
    public static void onPlayerDamaged() { isFlashingRed = true; flashTimer = 0; }
    public static void onPlayerExploded() { isShaking = true; shakeTimer = 0; }
    ...
    public static void reset() { currentSanity = 100.0f; darknessTimer = 0; currentTexture = BRAIN_100; isFlashingRed = false; isShaking = false; flashTimer = 0; shakeTimer = 0; }
}